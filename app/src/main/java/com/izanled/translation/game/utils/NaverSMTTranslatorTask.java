...
public class NaverSMTTranslatorTask extends AsyncTask<String, Void, String> {

    private final static String URL = "https://openapi.naver.com/v1/language/translate";
    private final static String TARGET = "&target=";
    private final static String SOURCE = "source=";
    private final static String TEXT = "&text=";

    String clientId = "G645t0W2sMi9frbeqcir";//애플리케이션 클라이언트 아이디값";
    String clientSecret = "vXvchvDXxG";//애플리케이션 클라이언트 시크릿값";

    Context mContext;
    EventListener eventListener;

    public NaverSMTTranslatorTask(Context context, EventListener eventListener) {
        mContext = context;
